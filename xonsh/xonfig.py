...
def make_env_wiz():
    ...
    return _make_flat_wiz(make_envvar, sorted(builtins.__xonsh__.env._docs.keys()))
...
def make_xontribs_wiz():
    ...
    return _make_flat_wiz(make_xontrib, md["xontribs"], pkgs)
